...
<div class="p-3 mb-3">
    ...
    <div class="p-3 ">
        ...
        <form action="add_category.php" method="post" enctype="multipart/form-data" name="cat_form" onsubmit="return validate()" >
            <div class="mb-3">
            ...
            <div class="input-group mb-3">
                ...
                <input type="file" name="category_img" id="category_img" name="category_img" require>
            </div>
